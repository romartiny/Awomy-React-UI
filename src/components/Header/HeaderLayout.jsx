        ...
        <AnimatePresence initial={false}>
          {
            isOpenNavigation && (
                <Popover className="lg:hidden">
                  <Popover.Overlay onClick={backgroundCloseClick} static as={motion.div} initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className="fixed z-20 inset-0 bg-gray-600/10 backdrop-blur cursor-default"/>
